...
# Blogroll
LINKS = (('Yuanbo She\'s blog', 'http://my.phirobot.com'), 
         ('Fuqiang Liu\'s blog', 'http://roboturing.com/blog/index.html'),
         ('Old blog', 'http://www.cnblogs.com/freedomshe'),)
...
TEMPLATE_PAGES = {'about.html': 'about.html',
                  ...
                  'ubuntu_for_ros.html': 'ubuntu_for_ros.html'}
#                  'pages/home.html': 'index.html'}

MENUITEMS = (('Home', 'index.html'),
             ('Ubuntu for ROS', 'ubuntu_for_ros.html'),
             ('About', 'abouts.html'),
             ('Pages', 'pages.html'),
